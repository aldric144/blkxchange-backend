...
def seed_database():
    ...
    db.create_product(vendor1.id, ProductCreate(
        ...
        price=89.99,
        category=ProductCategory.APPAREL_ACCESSORIES,
    ...
    db.create_product(vendor2.id, ProductCreate(
        ...
        price=24.99,
        category=ProductCategory.BEAUTY_WELLNESS,
    ...
    db.create_product(vendor3.id, ProductCreate(
        ...
        price=16.99,
        category=ProductCategory.BOOKS_STATIONERY,
    ...
    db.create_product(vendor4.id, ProductCreate(
        ...
        price=125.00,
        category=ProductCategory.ART_COLLECTIBLES,
    ...
    db.create_product(vendor5.id, ProductCreate(
        ...
        price=89.99,
        category=ProductCategory.TECHNOLOGY_GADGETS,
    ...
    db.create_professional(ProfessionalCreate(
        ...
        category=ProfessionalCategory.HEALTH_MEDICAL,
        ...
        hourly_rate=200.00,
        phone="555-0201",
        website="https://drsarahthompson.com",
    ...
    db.create_professional(ProfessionalCreate(
        ...
        category=ProfessionalCategory.LEGAL_ADVOCACY,
        ...
        hourly_rate=350.00,
        phone="555-0202",
        website="https://jacksonlawfirm.com",
    ...
    db.create_professional(ProfessionalCreate(
        ...
        category=ProfessionalCategory.FINANCE_INSURANCE,
        ...
        hourly_rate=175.00,
        phone="555-0203",
        website="https://financialfreedomadvisors.com",
    ...
    db.create_professional(ProfessionalCreate(
        ...
        category=ProfessionalCategory.COACHING_CONSULTING,
    ...
    db.create_professional(ProfessionalCreate(
        ...
        category=ProfessionalCategory.EDUCATION_TUTORING,
    ...
    db.create_professional(ProfessionalCreate(
        ...
        category=ProfessionalCategory.REAL_ESTATE_WEALTH,
    ...
    db.create_professional(ProfessionalCreate(
        ...
        category=ProfessionalCategory.EVENT_HOSPITALITY,
    ...
    db.create_professional(ProfessionalCreate(
        ...
        category=ProfessionalCategory.TRANSPORTATION_LOGISTICS,
    ...
    db.create_professional(ProfessionalCreate(
        ...
        category=ProfessionalCategory.NONPROFITS_COMMUNITY,
